const textUtils = {
    about: "Aniview is a companion for MyAnimeList.net which shows some info about your animelist from MAL with data fetched via the official MAL API and Jikan. The site is currently under active development so it may not be stable. This is a non-commercial open source project.",
