...
//   const [responseData, setResponseData] = useState({           !! TESTING WITH MOCK DATA / SWITCH BACK TO API !!
//     "data": [],
//     "count": 0
// });
const [responseData, setResponseData] = useState({...testData});      // temp test data
  ...
  const HomeComponent = () => {
    if(userAquired){
      return <HomeLander handleInputFromMainSearch={handleInputFromMainSearch} lvhAnimeArray={responseData} loading={loading}/>;
    } else {
